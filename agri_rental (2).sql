...
--
-- Table structure for table `ar_users_live_stock_booking`
--

CREATE TABLE `ar_users_live_stock_booking` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `uname` varchar(60) NOT NULL,
  `provider` varchar(60) NOT NULL,
  `livestockid` varchar(60) NOT NULL,
...
--
-- Dumping data for table `ar_users_live_stock_booking`
--

INSERT INTO `ar_users_live_stock_booking` (`id`, `uname`, `provider`, `livestockid`, `utype`, `req_date`, `status`, `amount`, `rdate`, `created_at`, `updated_at`) VALUES
(1, 'jebin', 'raja', '1', 'Farmer', '2023-12-17', '1', '15000', '09-12-2023', NULL, NULL),
(2, 'godl', 'raja', '1', 'Customer', '2023-12-17', '0', '15000', '09-12-2023', NULL, NULL),
(3, 'godl', 'selva', '2', 'Customer', '2023-12-31', '1', '15000', '11-12-2023', NULL, NULL);
...
(18, '2023_12_08_132345_create_ar_users_live_stock_booking_table', 14);
...
--
-- Indexes for table `ar_users_live_stock_booking`
--
ALTER TABLE `ar_users_live_stock_booking`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `ar_users_live_stock_booking`
--
ALTER TABLE `ar_users_live_stock_booking`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
